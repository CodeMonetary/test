...
#pragma region D3D9Device
	...
	{
		Mirror::OnBeginScene(m_pIDirect3DDevice9);
		return m_pIDirect3DDevice9->BeginScene();
	}

	HRESULT D3D9Ex::D3D9Device::EndScene()
	{
		Mirror::OnEndScene(m_pIDirect3DDevice9);
		GUI::LoopRender();
	...
	{
		Mirror::OnSetRenderState(m_pIDirect3DDevice9, State, Value);
	...
	HRESULT D3D9Ex::D3D9Device::DrawPrimitive(D3DPRIMITIVETYPE PrimitiveType, UINT StartVertex, UINT PrimitiveCount)
	{
		...
		Mirror::OnDrawPrimitive_Post(m_pIDirect3DDevice9);
		return hr;
	}
	...
	HRESULT D3D9Ex::D3D9Device::DrawIndexedPrimitive(D3DPRIMITIVETYPE PrimitiveType, INT BaseVertexIndex, UINT MinVertexIndex, UINT NumVertices, UINT startIndex, UINT primCount)
	{
		...
		Mirror::OnDrawIndexedPrimitive_Post(m_pIDirect3DDevice9);
		return hr;
	}
	...
	{
		const float* upload = pConstantData;
		Mirror::OnSetVertexShaderConstantF(m_pIDirect3DDevice9,
			StartRegister, pConstantData, Vector4fCount, &upload);
		return m_pIDirect3DDevice9->SetVertexShaderConstantF(StartRegister, upload, Vector4fCount);
	}
	...
	HRESULT D3D9Ex::D3D9Device::SetPixelShaderConstantF(UINT StartRegister, CONST float* pConstantData, UINT Vector4fCount)
	{
		...
		Mirror::OnSetPixelShaderConstantF(m_pIDirect3DDevice9, StartRegister, pConstantData, Vector4fCount);
