// cod4mirror — IDirect3DDevice9 wrapper (passthrough scaffold for Phase 1).
// Method list mirrors iw3xo d3d9ex.hpp so future port can drop in straight.
#pragma once
#include <Windows.h>
#include <d3d9.h>
...
namespace cod4mirror
{
	...
	{
	public:
		explicit D3D9Device(IDirect3DDevice9* pOriginal) : m_orig(pOriginal) {}
		virtual ~D3D9Device() = default;

		IDirect3DDevice9* original() const { return m_orig; }
