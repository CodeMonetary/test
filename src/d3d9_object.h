// cod4mirror — IDirect3D9 wrapper. Sole reason it exists: intercept
// CreateDevice so we can wrap the returned IDirect3DDevice9.
#pragma once
#include <Windows.h>
#include <d3d9.h>
...
{
	class D3D9Object final : public IDirect3D9
	{
	public:
		explicit D3D9Object(IDirect3D9* pOriginal) : m_orig(pOriginal) {}
		virtual ~D3D9Object() = default;
